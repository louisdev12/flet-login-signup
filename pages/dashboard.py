                ...
                ft.Row([
                    ft.Row([
                        ft.IconButton(
                            ...
                            icon_size=22,
                            tooltip=ft.Tooltip(message='Likes', bgcolor=ft.Colors.with_opacity(0.3, ft.Colors.BLACK), text_style=ft.TextStyle(color=ft.Colors.WHITE)),
                            ref=like_icon,
                    ...
                    ft.Row([
                        ft.IconButton(ft.Icons.CHAT_BUBBLE_OUTLINE, icon_color=ft.Colors.WHITE, icon_size=20, tooltip=ft.Tooltip(message='Chats', bgcolor=ft.Colors.with_opacity(0.3, ft.Colors.BLACK), text_style=ft.TextStyle(color=ft.Colors.WHITE))),
                        ft.Text(str(comments), color=ft.Colors.GREY_400, size=13)
                    ], spacing=4),
                    ft.Row([
                        ft.IconButton(ft.Icons.SHARE_OUTLINED, icon_color=ft.Colors.WHITE, icon_size=20, tooltip=ft.Tooltip(message='Share', bgcolor=ft.Colors.with_opacity(0.3, ft.Colors.BLACK), text_style=ft.TextStyle(color=ft.Colors.WHITE))),
                    ...
                    ft.IconButton(
                        ...
                        icon_color=ft.Colors.WHITE,
                        icon_size=20,
                        tooltip=ft.Tooltip(message='Save', bgcolor=ft.Colors.with_opacity(0.3, ft.Colors.BLACK), text_style=ft.TextStyle(color=ft.Colors.WHITE)),
                        ref=save_icon,
                ...
                content=ft.Column([
                    ...
                    ft.Container(
                        content=ft.Row([
                            ...
                            ft.Row([
                                ft.IconButton(ft.Icons.FAVORITE_BORDER, icon_color=ft.Colors.WHITE, icon_size=24, tooltip=ft.Tooltip(message='Likes',bgcolor=ft.Colors.with_opacity(0.3, ft.Colors.BLACK), text_style=ft.TextStyle(color=ft.Colors.WHITE))),
                                ft.IconButton(ft.Icons.CHAT_BUBBLE_OUTLINE, icon_color=ft.Colors.WHITE, icon_size=24, tooltip=ft.Tooltip(message='Chats',bgcolor=ft.Colors.with_opacity(0.3, ft.Colors.BLACK), text_style=ft.TextStyle(color=ft.Colors.WHITE))),
                                ft.PopupMenuButton(
                                    content=ft.Container(
                                        ...
                                        border_radius=16,
                                        alignment=ft.alignment.center,
                                        tooltip=ft.Tooltip(message='Profile', bgcolor=ft.Colors.with_opacity(0.3, ft.Colors.BLACK), text_style=ft.TextStyle(color=ft.Colors.WHITE)),
                                    ),
                                    items=[
